...
from app.api.v1.endpoints import admin, ai, auth, dashboard, enums, health, projects, scores, students, tasks, users
...
api_router.include_router(ai.router, prefix="/ai", tags=["AI语音助手"])
